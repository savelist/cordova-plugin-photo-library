cordova.define("cordova-plugin-photo-library.PhotoLibrary", function (require, exports, module) {
  ...
  photoLibrary.getThumbnailURL = function (photoIdOrLibraryItem, success, error, options) {
    ...
    if (success) {
      if (isBrowser) {
        cordova.exec(function (thumbnailURL) {
          success(thumbnailURL + '#' + urlParams);
        }, error, 'PhotoLibrary', '_getThumbnailURLBrowser', [photoId, options]);
      } else {
  ...
  photoLibrary.getPhotoURL = function (photoIdOrLibraryItem, success, error, options) {
    ...
    if (success) {
      if (isBrowser) {
        cordova.exec(function (photoURL) {
